...
public class GetVideoAd extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            String url = AdHubConfig.URL_ADVERTISE_VIDEO + "?app_id=" + SharedPreferencesManager.getInstance(this.context).getAppId() + "&zone_id=" + zoneId + "&type=video";
