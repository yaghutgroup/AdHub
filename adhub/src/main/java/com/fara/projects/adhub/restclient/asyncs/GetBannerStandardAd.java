...
public class GetBannerStandardAd extends AsyncTask<Void, Void, String> {
    private Context context;
    private String zoneId;
    private HTTPRequestHelper.OnCallBackListener callBackListener;

    public GetBannerStandardAd(Context context, String zoneId, HTTPRequestHelper.OnCallBackListener callBackListener) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            String url = AdHubConfig.URL_ADVERTISE_BANNER_STANDARD + "?app_id=" + SharedPreferencesManager.getInstance(this.context).getAppId() + "&zone_id=" + zoneId + "&type=banner_standard";
