...
public class GetAllSdkAppID extends AsyncTask<Void, Void, String> {
    private Context context;
    private HTTPRequestHelper.OnCallBackListener callBackListener;

    public GetAllSdkAppID(Context context, HTTPRequestHelper.OnCallBackListener callBackListener) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            String url = AdHubConfig.URL_GET_ALL_SDK_APP_ID + "?app_id=" + SharedPreferencesManager.getInstance(this.context).getAppId();
